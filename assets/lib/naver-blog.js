...
(function(window) {
    ...
    window.NB_blogStat['방문분석']['조회수'] = NB_blogStatFunc('visit/cv', prev_week, 'DATE');
    window.NB_blogStat['방문분석']['순방문자수'] = NB_blogStatFunc('visit/uv', prev_week, 'DATE');
    window.NB_blogStat['방문분석']['방문횟수'] = NB_blogStatFunc('visit/visit', prev_week, 'DATE');
    window.NB_blogStat['방문분석']['평균방문횟수'] = NB_blogStatFunc('visit/averageVisit', prev_week, 'WEEK');
    window.NB_blogStat['방문분석']['재방문율'] = NB_blogStatFunc('visit/revisit', prev_week, 'DATE');
    window.NB_blogStat['방문분석']['평균사용시간'] = NB_blogStatFunc('visit/averageDuration', prev_week, 'DATE');
    // 사용자분석
    ...
    window.NB_blogStat['사용자분석']['성별연령별분포']['조회수'] = NB_blogStatFunc('user/demoCv', prev_week, 'DATE');
    window.NB_blogStat['사용자분석']['성별연령별분포']['순방문자수'] = NB_blogStatFunc('user/demoUv', prev_week, 'DATE');
    window.NB_blogStat['사용자분석']['기기별분포'] = NB_blogStatFuncGroup(prev_week, 'DATE');
    window.NB_blogStat['사용자분석']['기기별분포']['모바일'] = NB_blogStatFunc('user/device/mobile', prev_week, 'DATE');
    window.NB_blogStat['사용자분석']['기기별분포']['PC'] = NB_blogStatFunc('user/device/pc', prev_week, 'DATE');
    window.NB_blogStat['사용자분석']['이웃방문현황'] = NB_blogStatFuncGroup(prev_week, 'DATE');
    window.NB_blogStat['사용자분석']['이웃방문현황']['조회수'] = NB_blogStatFunc('user/relationVisitCv', prev_week, 'DATE');
    window.NB_blogStat['사용자분석']['이웃방문현황']['순방문자수'] = NB_blogStatFunc('user/relationVisitUv', prev_week, 'DATE');
    window.NB_blogStat['사용자분석']['이웃증감수'] = NB_blogStatFunc('user/relationDelta', prev_week, 'DATE');
    ...
    window.NB_blogStat['사용자분석']['국가별분포'] = NB_blogStatFunc('user/country', prev_week, 'DATE');
    // 시간대분석
