...
GM_App(async function main() {
    ...
    .custom-keyword-planner .custom-basic-column[data-tooltip]:hover::after { content: attr(data-tooltip); white-space: pre; padding: 1rem; position: absolute; z-index: 100000; right: 50%; top: 50%; font-size: 11px; background-color: #c4dff6; border: 1px solid #333; min-width: 480px; max-width: 720px; max-height: 200px; overflow-y: auto; text-align: left; }
