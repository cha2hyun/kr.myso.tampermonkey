...
GM_App(async function main() {
    ...
    GM_addStyle(`
      ...
      .blog-keywords-total-loading:after { content: "데이터 불러오는 중..."; color: #fff; font-family:  Lato,"Helvetica Neue" ; font-weight: 200; font-size: 16px; position: absolute; width: 100%; height: 20px; line-height: 20px; left: 0; top: 0; background-color: #e74c3c; z-index: 1; }
